...
module Garb
  class ReportTest < Test::Unit::TestCase
    ...
    context "An instance of the Report class" do
      ...
      should "have parameters for the data request"
      should "send a data request"
      should "parse the metrics from the data response"
      should "parse the dimensions from the data response"
      ...
      should "create a new request with URL and params" do
        # data_request = mock
        # DataRequest.expects(:new).with(Report::URL, @report.params).returns(data_request)
        # assert_equal data_request, @report.request
      end
